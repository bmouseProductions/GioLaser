    ...
    return(
        ...
        >
            {slideContent.map((content, index:number) => (
                <SwiperSlide key={index} className='w-full h-full flex justify-center items-center py-10 px-5 bg-gradient-to-r from-[#75399960] from-0% via-[#c546af90] via-50% to-[#75399960] to-90% '>
                    {content}
                </SwiperSlide>
            ))}
        </Swiper>
