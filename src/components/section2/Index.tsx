...
export default function Section2() {
    ...
    return (
        <section className="py-10 w-full min-h-[50vh] lg:min-h-screen flex flex-col  items-center max-w-screen text-white bg-gradient-to-b  from-[#610061] from-70% via-[#a528ad] via-80% to-[#ca4ab0] to-90% ">
            ...
            <div className="w-full flex flex-col items-center gap-10 md:mb-12 p-5" data-aos="zoom-in-up" data-aos-duration="1500">
            ...
            <div className="w-full p-5 md:p-0 flex flex-col items-center ">
                <h2 className="w-full md:w-[80%] max-w-[1350px] text-2xl xl:text-[38px] md:text-4xl font-bold text-center" data-aos="fade-up" data-aos-duration="1500">A GiOlaser nasceu do propósito de promover saúde e beleza para todas as pessoas. Acreditamos que o bem-estar vem de dentro para fora.</h2>
                <h3 className="w-full my-12 text-2xl xl:text-[36px] md:text-3xl font-semibold text-center" data-aos="fade-up" data-aos-duration="1500">
                ...
                <p className="my-10 max-w-[800px] text-[26px] md:text-2xl font-semibold text-center" data-aos="fade-up" data-aos-duration="1500">
